...
export default function EmotesService() {
  return (
    <>
      <Navbar />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6" style={{ fontFamily: 'var(--font-playfair)' }}>
              <span className="text-gold">Emotes</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Custom emotes that express your personality. Cute, fun, expressive emotes made for Twitch & Discord.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-3">
                  {[
                    'Custom emote designs tailored to your brand',
                    'Multiple expressions and variations',
                    'Platform-specific sizing (Twitch, Discord, etc.)',
                    'High-quality files for crisp display',
              ...
              <div className="space-y-6">
                <div className="border-b border-gray-700 pb-6">
                  ...
                  <ul className="space-y-2 mb-4">
                    {['5 emote designs', 'Basic expressions', 'Twitch or Discord format', 'PNG files'].map((item, index) => (
                ...
                <div className="border-b border-gray-700 pb-6">
                  ...
                  <ul className="space-y-2 mb-4">
                    {['15 emote designs', 'Multiple expressions', 'Twitch & Discord formats', 'Animated options', 'Priority support'].map((item, index) => (
                      <li key={index} className="flex items-center text-gray-300">
                        <span className="text-[#d4af37] mr-2">✓</span>
                        {item}
                      </li>
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-3">Complete emote set</p>
                  <ul className="space-y-2 mb-4">
                    {['30+ emote designs', 'Full expression sets', 'Animated & static options', 'Multiple platform formats', 'Extended license'].map((item, index) => (
                      <li key={index} className="flex items-center text-gray-300">
                        <span className="text-[#d4af37] mr-2">✓</span>
                        {item}
                      </li>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                { step: '01', title: 'Consultation', desc: 'We discuss your brand and emote style' },
                { step: '02', title: 'Design', desc: 'We create initial emote concepts' },
