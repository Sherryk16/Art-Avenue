...
export default function TwitchYouTubeOverlaysService() {
  return (
    <>
      <Navbar />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            >
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Your overlay is what separates a professional stream from an amateur one. A well-designed overlay 
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Easy to implement in streaming software',
              ...
              <div className="space-y-6">
                <div className="border-b border-gray-700 pb-6">
                  ...
                  <ul className="space-y-2 mb-4">
                    {['1 overlay design', 'Basic animated elements', 'OBS compatible', 'Simple scene transitions'].map((item, index) => (
                ...
                <div className="border-b border-gray-700 pb-6">
                  ...
                  <ul className="space-y-2 mb-4">
                    {['3 overlay designs', 'Advanced animations', 'Multiple scene variations', 'Custom alerts integration', 'Setup guide'].map((item, index) => (
                      <li key={index} className="flex items-center text-gray-300">
                        <span className="text-[#d4af37] mr-2">✓</span>
                        {item}
                      </li>
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-3">Complete streaming solution</p>
                  <ul className="space-y-2 mb-4">
                    {['5+ overlay designs', 'Fully animated elements', 'Interactive components', 'Custom sound effects', 'Priority support'].map((item, index) => (
                      <li key={index} className="flex items-center text-gray-300">
                        <span className="text-[#d4af37] mr-2">✓</span>
                        {item}
                      </li>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                ...
                { step: '02', title: 'Design', desc: 'We create overlay concepts based on your brand' },
                { step: '03', title: 'Implementation', desc: 'We integrate with your streaming software' },
