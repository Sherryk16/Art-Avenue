                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#d4af37] to-[#f4e4bc] flex items-center justify-center text-2xl">
                      <SocialIcon network="gmail" url="mailto:support@artavenueproductions.com" bgColor="transparent" fgColor="#000" style={{ width: 40, height: 40 }} />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-4 pt-4">
                    ...
                    <motion.a
                      ...
                      whileTap={{ scale: 0.9 }}
                    >
                      <SocialIcon network="gmail" url="mailto:support@artavenueproductions.com" bgColor="transparent" fgColor="#d4af37" style={{ width: 40, height: 40 }} />
                    </motion.a>
                  </div>
                </div>
              </div>
